...
public class AppException extends Exception implements UncaughtExceptionHandler{
	...
	public final static byte TYPE_CUSTOM	 	= 0x09;
	public final static byte TYPE_SQLITE		= 0x0A;
	...
	private AppException(byte type, String message) {
		super(message);
		this.type = type;
	}
	...
	public void makeToast(Context ctx){
		...
		case TYPE_JSON:
			...
			break;
		case TYPE_CUSTOM:
			Toast.makeText(ctx, this.getMessage(), Toast.LENGTH_SHORT).show();
			break;
		case TYPE_SQLITE:
			Toast.makeText(ctx, "数据库操作失败", Toast.LENGTH_SHORT).show();
			break;
		}
	}
	...
	public static AppException custom(String message) {
		return new AppException(TYPE_CUSTOM, message);
	}
	
	public static AppException sqlite(Exception e) {
		return new AppException(TYPE_SQLITE, 0, e);
	}
